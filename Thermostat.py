...
class TemperatureMachine(StateMachine):
    ...
    def updateLights(self):
        ...
        if self.current_state == self.heat:
            if temp < self.setPoint:
                redLight.pulse()  # Fading on/off
            else:
                redLight.on()  # Solid red light when at or above 
        
        elif self.current_state == self.cool:
            if temp > self.setPoint:
                blueLight.pulse()  # Fading on/off
            else:
                blueLight.on()  # Solid blue light when at or below 
    ...
    def setupSerialOutput(self):
        ...
        if(DEBUG):
            print("Setting up Serial Output...")
            print(f"State: {self.current_state.id}")
            print(f"Temp: {temp}")
            print(f"SetPoint: {self.setPoint}")
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                lcd_line_2 = f"{self.current_state.id.capitalize()} set@ {self.setPoint} F"
                altCounter = altCounter + 1
            ...
            if((counter % 30) == 0):
                ...
                ser.write(self.setupSerialOutput().encode('utf-8') + b'\n')
